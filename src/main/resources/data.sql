...
VALUES ('karel', 'karel', 'appel', '25-04-1921', 101, 'karelappel@gmail.com', 'ROLE_STUDENT', 'ONCE_A_MONTH', 'niks te melden', 'BEGINNER'),
       ('vincent', 'vincent', 'gogh', '30-03-1853', 169, 'vincentvangogh@gmail.com', 'ROLE_BUDDY','ONCE_A_WEEK', 'mijn oor is kapot', 'PROFICIENT'),
       ('japie', 'japie', 'krekel', '25-04-1981', 10, 'japiekrekel@gmail.com','ROLE_STUDENT', 'EVERY_DAY', 'about japie', 'ELEMENTARY'),
       ('boris', 'boris', 'johnson', '25-04-1521', 11, 'borisjohnson@gmail.com', 'ROLE_BUDDY', 'FEW_TIMES_A_MONTH', 'english president blabla', 'INTERMEDIATE'),
       ('joep', 'joep', 'meloen', '25-04-1951', 14, 'joepmeloen@gmail.com','ROLE_BUDDY', 'FEW_TIMES_A_WEEK', 'joep meloen hier', 'UPPER_INTERMEDIATE');
...
INSERT INTO requests (id, message, sender_username, receiver_username, status)
VALUES (100, 'test1', 'karel', 'vincent', 'PENDING'),
       (200, 'test2', 'vincent', 'karel', 'PENDING'),
       (300, 'test3', 'japie', 'karel', 'PENDING'),
       (400, 'test4', 'joep', 'karel', 'PENDING'),
       (500, 'test5', 'karel', 'boris', 'PENDING');
